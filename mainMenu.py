...
window = pygame.display.set_mode((0, 0), FULLSCREEN)    # creazione della finestra di gioco

# immagini della finestra
...
font = pygame.font.SysFont("Arial", 32, bold = True)    # carica il font in memoria

ngSurf = font.render("New Game", True, (255, 255, 255))         # renderizza le scritte con il font caricato
...
# creazione dei group contenenti gli sprite testuali

text = pygame.sprite.Group() 
text2 = pygame.sprite.Group()

# crezione degli sprite testuali
